<cfscript>
			variables[ "displayData" ] = variables[ "tmp_displayData_BB7BA081AF2736FE1BF403E41BEA4612" ];
			this[ "displayData" ]           = variables[ "tmp_displayData_BB7BA081AF2736FE1BF403E41BEA4612" ];
			// Clean up
			structDelete( variables, "tmp_displayData_BB7BA081AF2736FE1BF403E41BEA4612" );
			structDelete( this, "tmp_displayData_BB7BA081AF2736FE1BF403E41BEA4612" );

			public query function tmp_displayData_BB7BA081AF2736FE1BF403E41BEA4612( 

			) output=false {
 
			var results                 = this._mockResults;
			var resultsKey           = "displayData";
			...
			arrayAppend(this._mockCallLoggers["displayData"], arguments);
