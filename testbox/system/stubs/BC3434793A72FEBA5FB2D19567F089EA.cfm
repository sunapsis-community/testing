<cfscript>
			variables[ "testNone" ] = variables[ "tmp_testNone_BC3434793A72FEBA5FB2D19567F089EA" ];
			this[ "testNone" ]           = variables[ "tmp_testNone_BC3434793A72FEBA5FB2D19567F089EA" ];
			// Clean up
			structDelete( variables, "tmp_testNone_BC3434793A72FEBA5FB2D19567F089EA" );
			structDelete( this, "tmp_testNone_BC3434793A72FEBA5FB2D19567F089EA" );

			public any function tmp_testNone_BC3434793A72FEBA5FB2D19567F089EA( 

			) output=true {
 
			var results                 = this._mockResults;
			var resultsKey           = "testNone";
			...
			arrayAppend(this._mockCallLoggers["testNone"], arguments);
