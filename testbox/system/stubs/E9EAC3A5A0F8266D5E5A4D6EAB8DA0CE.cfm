<cfscript>
			variables[ "contains" ] = variables[ "tmp_contains_E9EAC3A5A0F8266D5E5A4D6EAB8DA0CE" ];
			this[ "contains" ]           = variables[ "tmp_contains_E9EAC3A5A0F8266D5E5A4D6EAB8DA0CE" ];
			// Clean up
			structDelete( variables, "tmp_contains_E9EAC3A5A0F8266D5E5A4D6EAB8DA0CE" );
			structDelete( this, "tmp_contains_E9EAC3A5A0F8266D5E5A4D6EAB8DA0CE" );

			public any function tmp_contains_E9EAC3A5A0F8266D5E5A4D6EAB8DA0CE( 
