<cfscript>
			variables[ "getSetting" ] = variables[ "tmp_getSetting_650A0989B07CA08544B38C8E88588B27" ];
			this[ "getSetting" ]           = variables[ "tmp_getSetting_650A0989B07CA08544B38C8E88588B27" ];
			// Clean up
			structDelete( variables, "tmp_getSetting_650A0989B07CA08544B38C8E88588B27" );
			structDelete( this, "tmp_getSetting_650A0989B07CA08544B38C8E88588B27" );

			public string function tmp_getSetting_650A0989B07CA08544B38C8E88588B27( 

			) output=true {
 
			var results                 = this._mockResults;
			var resultsKey           = "getSetting";
			...
			arrayAppend(this._mockCallLoggers["getSetting"], arguments);
